...
globals [
  ...
  number-of-collisions  ; count how many times uuv hits obstacles
...
to setup-environment
  ...
  read-experiment experiment-number
  ...
  set environment-folder "./environments/nav_error_trial/"  ; the folder containing environment setup files
