...
;  read-experiment experiment-number experiment-file
  ...
  set environment-folder "./environments/general_trial/"  ; the folder containing environment setup files
  ...
  ;; place the minefield
  lay-mines-from-file word environment-folder "minefield_1.txt"
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "histogram [position-error] of mine-markers"
...
<experiments>
  ...
  <experiment name="navigation error trial" repetitions="5" runMetricsEveryStep="true">
    <setup>setup-environment</setup>
    <go>go</go>
    <timeLimit steps="20000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>navigation-error</metric>
    <enumeratedValueSet variable="nav-velocity-std-cm">
      <value value="0.2"/>
      <value value="0.5"/>
      <value value="1"/>
    </enumeratedValueSet>
  ...
  <experiment name="obstacle-run" repetitions="20" runMetricsEveryStep="false">
    <setup>setup-environment</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <exitCondition>end-reached</exitCondition>
  ...
  <experiment name="obstacle-run-lhc" repetitions="1" runMetricsEveryStep="false">
    <setup>setup-environment</setup>
    <go>go</go>
    <timeLimit steps="40000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>number-of-collisions</metric>
    <steppedValueSet variable="experiment-number" first="0" step="1" last="299"/>
  </experiment>
  <experiment name="mine-run-lhc" repetitions="3" runMetricsEveryStep="false">
    <setup>setup-environment</setup>
    <go>go</go>
    <timeLimit steps="20000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>number-of-collisions</metric>
    <metric>mission-objective-metric</metric>
    <steppedValueSet variable="experiment-number" first="0" step="1" last="299"/>
    <enumeratedValueSet variable="nmines">
      <value value="20"/>
      <value value="50"/>
  ...
  <experiment name="mine_error_straight_run_1" repetitions="3" runMetricsEveryStep="false">
    <setup>setup-environment</setup>
    <go>go</go>
    <timeLimit steps="20000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>objective-mine-position</metric>
    <steppedValueSet variable="experiment-number" first="0" step="1" last="99"/>
    <enumeratedValueSet variable="nmines">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="minefield_minx">
  ...
  <experiment name="general experiment template" repetitions="5" runMetricsEveryStep="false">
    <setup>clear-all
let experiment-file "./experiments/general_trial/general_trial_run_1.txt"
read-experiment experiment-number experiment-file
set environment-folder "./environments/general_trial/"
setup-world word environment-folder "world_dims.txt"
load-mission-waypoints word environment-folder "mission_waypoints.txt"
load-vector-data word environment-folder "mission_leg_0.txt"
place-objects-from-file word environment-folder "obstacles.txt"
lay-mines-from-file word environment-folder "minefield_1.txt"
setup-uuv
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/general_trial/general_trial_2"</final>
    <timeLimit steps="15000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>objective-mine-speed</metric>
    <metric>objective-mine-position</metric>
    <metric>objective-mine-detected-ratio</metric>
    <metric>number-of-collisions</metric>
    <metric>max-nav-error</metric>
    <steppedValueSet variable="experiment-number" first="0" step="1" last="299"/>
  </experiment>
  <experiment name="bugfix" repetitions="5" runMetricsEveryStep="false">
    <setup>clear-all
let experiment-file "./experiments/bugfix_experiment/bugfix_1.txt"
read-experiment experiment-number experiment-file
set environment-folder "./environments/general_trial/"
setup-world word environment-folder "world_dims.txt"
load-mission-waypoints word environment-folder "mission_waypoints.txt"
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/bugfix_experiment/bugfix_1_2"</final>
    <timeLimit steps="15000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>objective-mine-speed</metric>
    <metric>objective-mine-position</metric>
    ...
    <steppedValueSet variable="experiment-number" first="0" step="1" last="199"/>
  </experiment>
  <experiment name="bugfix_small_test" repetitions="1" runMetricsEveryStep="false">
    <setup>cp
cd
ct
clear-all-plots
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/bugfix_experiment/bugfix_5"</final>
    <timeLimit steps="15000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>objective-mine-speed</metric>
    <metric>objective-mine-position</metric>
  ...
  <experiment name="baseline1" repetitions="10" runMetricsEveryStep="false">
    <setup>cp
cd
ct
clear-all-plots
...
set number-of-collisions 0
set max-nav-error 0
let experiment-file "./experiments/baseline1/baseline1.txt"
read-experiment experiment-number experiment-file
set environment-folder "./environments/general_trial/"
setup-world word environment-folder "world_dims.txt"
load-mission-waypoints word environment-folder "mission_waypoints.txt"
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/baseline1/baseline1"</final>
    <timeLimit steps="15000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>objective-mine-speed</metric>
    <metric>objective-mine-position</metric>
  ...
  <experiment name="baseline2" repetitions="10" runMetricsEveryStep="false">
    <setup>cp
cd
ct
clear-all-plots
...
set number-of-collisions 0
set max-nav-error 0
let experiment-file "./experiments/baseline2/baseline2.txt"
read-experiment experiment-number experiment-file
set environment-folder "./environments/general_trial/"
setup-world word environment-folder "world_dims.txt"
load-mission-waypoints word environment-folder "mission_waypoints.txt"
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/baseline2/mine-marker-datafiles_2/baseline2"</final>
    <timeLimit steps="18000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>objective-mine-speed</metric>
    <metric>objective-mine-position</metric>
    <metric>objective-mine-detected-ratio</metric>
    ...
    <metric>[link-length] of fix-links</metric>
    <steppedValueSet variable="experiment-number" first="0" step="1" last="299"/>
  </experiment>
</experiments>
@#$#@#$#@
