...
reset-ticks</setup>
  ...
  <experiment name="horseshoe1" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>cp
cd
ct
clear-all-plots
...
set number-of-collisions 0
set max-nav-error 0
let experiment-file "./experiments/horseshoe_trial/nolh.txt"
read-experiment experiment-number experiment-file
set environment-folder "./environments/horseshoe_trial/"
setup-world word environment-folder "world_dims.txt"
load-mission-waypoints word environment-folder "mission_waypoints.txt"
load-vector-data word environment-folder "mission_leg_0.txt"
place-objects-from-file word environment-folder "obstacles.txt"
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/horseshoe_trial/mine-marker-datafiles/horseshoe1"</final>
  ...
  <experiment name="horseshoe version 2 lhs" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>cp
cd
ct
clear-all-plots
...
set number-of-collisions 0
set max-nav-error 0
let experiment-file "./experiments/version2/v2_pyDOE_lhs.txt"
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/version2/mine-marker-datafiles/horseshoe_v2"</final>
    <timeLimit steps="20000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>objective-mine-speed</metric>
    <metric>objective-mine-position</metric>
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/version2/mine-marker-datafiles-run-2/horseshoe_v2"</final>
  ...
  <experiment name="horseshoe version 2 nolh" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>cp
cd
ct
clear-all-plots
...
set number-of-collisions 0
set max-nav-error 0
let experiment-file "./experiments/version2/v2_NOLH.txt"
read-experiment-v2 experiment-number experiment-file
set environment-folder "./environments/horseshoe_trial/"
setup-world word environment-folder "world_dims.txt"
load-mission-waypoints word environment-folder "mission_waypoints.txt"
...
reset-ticks</setup>
    <go>go</go>
    <final>write-mine-marker-to-file "./experiments/version2/mine-marker-datafiles-run-3/horseshoe_v2"</final>
    <timeLimit steps="35000"/>
    <exitCondition>end-reached</exitCondition>
    <metric>number-of-collisions</metric>
    <metric>max-nav-error</metric>
